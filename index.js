(() => {
  ...
  var { ScrollView } = import_common.ReactNative;
  var { FormSection, FormRow, FormSwitch, FormInput, FormDivider } = import_components.Forms;
  function Settings() {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(ScrollView, { style: { flex: 1 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(FormSection, { title: "fake name (only u see btw)", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(FormSection, { title: "snag from user id", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          FormInput,
          {
            title: "user id",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormSection, { title: "fake badges", children: Object.keys(BADGES).map((key) => {
        const badge = BADGES[key];
        return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_common.React.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            FormRow,
            {
  ...
  if (!import_plugin2.storage.activeBadges)
    import_plugin2.storage.activeBadges = [];
  if (!import_plugin2.storage.hiddenBadges)
  ...
  function captureFromUserId(targetId) {
    try {
      ...
      if (!user && !profile) {
        (0, import_toasts2.showToast)("user not cached, open their profile first lol", { type: 2 });
        return;
      }
      let added = 0;
      ...
      (0, import_toasts2.showToast)(`snagged ${added} badge${added !== 1 ? "s" : ""} from ${name}`, { type: 1 });
    } catch (e) {
  ...
  var onLoad = () => {
    try {
      ...
      patches.push((0, import_patcher.after)("getUserProfile", UserProfileStore, ([id], profile) => {
      ...
      patches.push((0, import_patcher.after)("getUser", UserStore, ([id], user) => {
        if (!user || id !== userId)
          return;
        modifyUser(user);
      }));
